...
public class PokerTableController {
	...
	//		if (p.getiPlayerPosition() == 1) {
				...
				//take out switch, create helper function that determines hbox
				// dependent upon an input of player position
				
				switch (p.getiPlayerPosition()){
				case 1:  
					
				imgvCardFaceDown = (ImageView) hBoxP1Cards.getChildren().get(iCardDrawn - 1);			
				bndCardDealt = imgvCardFaceDown.localToScene(imgvCardFaceDown.getBoundsInLocal());
				pntCardDealt = new Point2D(bndCardDealt.getMinX(), bndCardDealt.getMinY());
				break;
				
				case 2:  
					
				imgvCardFaceDown = (ImageView) hBoxP2Cards.getChildren().get(iCardDrawn - 1);			
				bndCardDealt = imgvCardFaceDown.localToScene(imgvCardFaceDown.getBoundsInLocal());
				pntCardDealt = new Point2D(bndCardDealt.getMinX(), bndCardDealt.getMinY());
				break;
				...
				imgvCardFaceDown = (ImageView) hBoxP3Cards.getChildren().get(iCardDrawn - 1);			
				 bndCardDealt = imgvCardFaceDown.localToScene(imgvCardFaceDown.getBoundsInLocal());
				pntCardDealt = new Point2D(bndCardDealt.getMinX(), bndCardDealt.getMinY());
				break;
				...
				imgvCardFaceDown = (ImageView) hBoxP4Cards.getChildren().get(iCardDrawn - 1);			
				bndCardDealt = imgvCardFaceDown.localToScene(imgvCardFaceDown.getBoundsInLocal());
				pntCardDealt = new Point2D(bndCardDealt.getMinX(), bndCardDealt.getMinY());
				break;
